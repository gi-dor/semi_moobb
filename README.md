<h2 align="center">📚[이사 중개 플랫폼] wouldYou 📚</h2>
...
- 실제 팀원의 이사를 하게되면서 업체 선정에 어려움을 느껴 사용자와 이사업체 중개를 하는 플랫폼 제작
- 프로젝트 이름 :  이사 중개 플랫폼 wouldYou
...
- 로그인을 하지 않았다면 X , A ,B ,C 버튼이 보이게 하느라 손으로 직접 그려가며 구상하고 다른 팀원들의 개발에 맞춰 navbar를 계속 해서 수정했습니다
